/**
 * ProCoder authentication model (how the four “actors” relate to storage and routes)
 *
 ...
 *    Token is stored as `localStorage.procoder_admin_token` (see `admin-api.ts`), not `token`.
