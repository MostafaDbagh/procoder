...
import { Code2, Bot, Brain, BookOpen, BookMarked, ArrowRight } from "lucide-react";

const categories = [
  { key: "programming", descKey: "programmingDesc", icon: Code2, color: "#3B82F6", borderColor: "border-b-blue-400", emoji: "💻" },
  { key: "robotics", descKey: "roboticsDesc", icon: Bot, color: "#10B981", borderColor: "border-b-emerald-400", emoji: "🤖" },
  { key: "algorithms", descKey: "algorithmsDesc", icon: Brain, color: "#8B5CF6", borderColor: "border-b-violet-400", emoji: "🧩" },
  { key: "arabic", descKey: "arabicDesc", icon: BookOpen, color: "#F43F5E", borderColor: "border-b-rose-400", emoji: "📖" },
  { key: "quran", descKey: "quranDesc", icon: BookMarked, color: "#059669", borderColor: "border-b-emerald-500", emoji: "🕌" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-6">
            ...
            >
              <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Floating category icons popping out of the book */}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-7 mb-7">
          {categories.slice(0, 3).map((cat, i) => (
            <CategoryCard key={cat.key} cat={cat} i={i} t={t} />
          ))}
        </div>
...
function CategoryCard({
  ...
  return (
    <AnimatedCard delay={i * 0.1}>
      <LocalizedLink href="/courses" className="block group h-full">
        <div
