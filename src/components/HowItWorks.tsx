  ...
  return (
    <svg width="120" height="110" viewBox="0 0 120 110" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        stroke="#5B7FD6" strokeWidth="2.8" fill="none" strokeLinecap="round"
      />
      {/* Arrow head */}
      <path d="M38 10 L44 14 L38 19" stroke="#5B7FD6" strokeWidth="2.8" fill="none" strokeLinecap="round" strokeLinejoin="round" />
