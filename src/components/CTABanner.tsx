        ...
        <AnimatedSection>
          <div className="relative overflow-hidden rounded-3xl bg-primary p-10 sm:p-16 text-center">
            ...
            <div className="relative">
              ...
              <LocalizedLink
                href="/courses"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-white text-primary font-semibold text-lg shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300"
              >
                {t("cta")}
