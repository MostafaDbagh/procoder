...
export function LearnByFun() {
 ...
 {/* Background circle */}
 <circle cx="60" cy="60" r="50" fill="#c4b5fd" opacity="0.08" />
 <circle cx="60" cy="60" r="38" fill="#c4b5fd" opacity="0.06" />

 {/* Gamepad body */}
 <rect x="30" y="45" width="60" height="35" rx="12" fill="#c4b5fd" opacity="0.7" />
 ...
 {/* Left grip */}
 <path d="M30 60 Q22 62 20 72 Q19 78 24 80 L32 78 Q30 72 30 65Z" fill="#c4b5fd" opacity="0.6" />
 {/* Right grip */}
 <path d="M90 60 Q98 62 100 72 Q101 78 96 80 L88 78 Q90 72 90 65Z" fill="#c4b5fd" opacity="0.6" />
